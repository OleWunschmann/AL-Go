param(
    [Parameter(Mandatory = $false, HelpMessage = "The GitHub event name that triggered the workflow. If not specified, the event will be determined from the GITHUB_EVENT_NAME environment variable.")]
