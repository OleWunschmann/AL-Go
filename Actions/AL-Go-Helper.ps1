...
$defaultBcContainerHelperVersion = "https://github.com/OleWunschmann/navcontainerhelper/archive/refs/heads/fix-al-pipeline-run-tests-endless-loop.zip" # Must be double quotes. Will be replaced by BcContainerHelperVersion if necessary in the deploy step - ex. "https://github.com/organization/navcontainerhelper/archive/refs/heads/branch.zip"
